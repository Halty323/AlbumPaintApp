...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView buttonCircle, buttonPalette, buttonClearScreen, buttonLines;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonClearScreen = findViewById(R.id.button_lines);
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.button_circle:
                    album.setMode(Modes.CIRCLE);
                    break;
                case R.id.button_palette:
                    album.setMode(Modes.DRAWING);
                    break;
                case R.id.button_lines:
                    album.setMode(Modes.LINES);
                    break;
